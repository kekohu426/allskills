...
export default function SkillGeneratorEn() {
  ...
  const handleGenerate = async () => {
    ...
    if (!apiKey && usage.count >= DAILY_LIMIT) {
      setShowApiKey(true);
      setError(
        `Daily free quota used (${DAILY_LIMIT} times). Enter your GLM API Key to continue.`
      );
      return;
    }
  ...
  const jsonLd = {
    ...
    description: "Generate Claude Code SKILL.md online with quality score and one-click download.",
    url: `${site.domain}/en/tools/skill-generator`,
  ...
  return (
    <>
      <SeoHead
        title="Skill Generator - Create Claude Code Skills"
        description="Generate Claude Code SKILL.md online. Describe your need, get a full skill file with a quality score and one-click download."
        path="/en/tools/skill-generator"
      ...
      <section className="page-hero">
        <div>
          ...
          <p>Describe the skill you want, and AI will generate a complete SKILL.md file.</p>
        </div>
      </section>
      ...
      <section className="section">
        <div className="generator-card">
          <div className="generator-card__header">
            ...
            <p>Explain the task, domain, and expected workflow so the output is production-ready.</p>
          </div>

          <textarea
            className="generator-input"
            placeholder="Example: a skill that helps developers draft API docs with endpoint descriptions, request/response examples, error codes, and auth details..."
            value={input}
          ...
          {showApiKey && (
            <div className="api-key-section">
              <label>GLM API Key (optional, unlimited usage)</label>
              <input
                type="password"
          ...
          <div className="generator-actions">
            <span className="generator-hint">Today remaining: {remaining} / {DAILY_LIMIT}</span>
        ...
        {result && (
          <div className="generator-result">
            ...
            <div className="generator-result__actions">
              ...
              <button className="btn btn--ghost" onClick={handleDownload}>Download SKILL.md</button>
            </div>
          </div>
        )}
        ...
        <div className="generator-how">
          ...
          <div className="generator-steps">
            <div className="generator-step">
              ...
              <h4>Describe</h4>
              <p>Explain the skill goals and triggers.</p>
            </div>
            <div className="generator-step">
              <span className="generator-step__num">02</span>
              <h4>Generate</h4>
              <p>AI builds a full SKILL.md with a quality score.</p>
            </div>
            <div className="generator-step">
              <span className="generator-step__num">03</span>
              <h4>Use</h4>
              <p>Download and drop it into your skills directory.</p>
            </div>
          </div>
        </div>
      </section>
